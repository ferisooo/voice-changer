...
> ### About this version (maintained by feris)
>
> **This is not my software. I (feris) do not claim ownership of this voice
> changer.** It is an updated, quality-of-life version of the excellent work by
> others:
>
> - Original project: **w-okada/voice-changer** — <https://github.com/w-okada/voice-changer> (MIT License — see [`LICENSE`](./LICENSE))
> - Optimized real-time fork this build is based on: **Deiteris/voice-changer** — <https://github.com/deiteris/voice-changer>
>
> All credit for the core real-time voice-conversion engine goes to them. This
> version simply adds the convenience and tuning features listed below on top of
> Deiteris's optimized, RVC-focused fork. There is **no affiliation with, or
> endorsement by, w-okada or Deiteris.**
>
> See also: [`PRIVACY.md`](./PRIVACY.md) and [`TERMS.md`](./TERMS.md).
>
> #### What's different / improved in this version
>
> Everything below is about making real-time voice changing easier to dial in
> and more stable — the conversion engine itself is unchanged:
>
> - **Auto Pitch** — automatically keeps your converted voice in the model's
>   comfortable pitch range so it doesn't drift squeaky or too deep, instead of
>   you having to nail a fixed pitch by hand.
> - **Noise-robust Auto Pitch** — ignores chair squeaks, taps and other
>   non-voice sounds so they can't yank your pitch around.
> - **Voice calibration** — talk for ~45s once and it saves a tiny *pitch
>   profile* (just numbers, **no audio is stored**). Auto Pitch then anchors to
>   your real voice instantly and rejects sounds outside your personal range.
> - **Pitch limits** — set the lowest/highest pitch Auto Pitch may use, so it
>   can never jump too far.
> - **Auto-smooth** — watches how hard the converting PC is working and adjusts
...
>   window is covered by OBS) and auto-finds the host PC by name on the LAN.
>
> These are usability and stability improvements; they do not change how the
> underlying models convert your voice.
